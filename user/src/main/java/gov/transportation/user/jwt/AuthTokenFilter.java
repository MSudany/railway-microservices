    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try{
            ...
            if (jwt != null && jwtUtils.validateToken(jwt)){
                ...
                PassengerDetails passengerDetails = passengerDetailsService.loadUserByUsername(email);
                var authentication =
                        new UsernamePasswordAuthenticationToken(passengerDetails, null, passengerDetails.getAuthorities());
